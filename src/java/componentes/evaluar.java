 ...
 * @author Toshiba
 */
@WebServlet(name = "evaluar", urlPatterns = {"/evaluar"})
public class evaluar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int puntajeIdeal = 39;
            double notaIdeal = 6.0;
            double notaFinal = 1;
            
            notaFinal = ((puntaje*notaIdeal)/puntajeIdeal)+notaFinal;
            
            DecimalFormat decimales = new DecimalFormat("0.0");
            
            validacion = String.valueOf(decimales.format(notaFinal));
